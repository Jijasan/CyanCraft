...
public class ItemCyanBow extends ElementsTestMod.ModElement {
	@GameRegistry.ObjectHolder("testmod:cyanbow")
	public static final Item block = null;
	public static final int ENTITYID = 3;
	public ItemCyanBow(ElementsTestMod instance) {
		super(instance, 74);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("testmod", "entitybulletcyanbow"), ENTITYID).name("entitybulletcyanbow").tracker(64, 1, true).build());
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("testmod:cyanbow", "inventory"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, renderManager -> {
			return new RenderSnowball(renderManager, new ItemStack(ItemCyanStick.block, (int) (1)).getItem(),
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(0);
			setFull3D();
			setUnlocalizedName("cyanbow");
			setRegistryName("cyanbow");
			maxStackSize = 1;
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, EntityLivingBase entityLivingBase, int timeLeft) {
			if (!world.isRemote && entityLivingBase instanceof EntityPlayerMP) {
				...
				if (entity.capabilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0
					...
					entityarrow.setDamage(228);
					entityarrow.setKnockbackStrength(228);
