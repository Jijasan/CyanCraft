...
import net.mcreator.testmod.procedure.ProcedureJij;
...
public class GuiTestGUI extends ElementsTestMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiTestGUI(ElementsTestMod instance) {
		super(instance, 20);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 134, 30) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("testmod:textures/testgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Casino", 7, 2, -12566464);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 79, this.guiTop + 47, 20, 20, "Diffichento"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureJij.executeProcedure($_dependencies);
			}
		}
	}
